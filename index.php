        ...
        <?php 
            ...
            $googleArr = [
                ...
                [
                    ...
                    'text' => "I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori di ricerca non possono rimuovere i contenuti direttamente dai siti web, quindi rimuovere risultati di ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web, <span> devi contattare il webmaster </span> del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, fai clic qui. Una volta che i contenuti saranno stati rimossi e che Google avrà rilevato l'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. In caso di una richiesta di rimozione urgente, è inoltre <span>possibile visitare la nostra pagina di assistenza per avere ulteriori informazioni.</span>"
                ],
                [
            ...
            foreach($googleArr as $strings){
                $subParagraphs = explode(PHP_EOL, $strings['text']);

                echo "<h2>" . $strings['title'] . "</h2>" . "<br>";
                // for su subParagraphs  "<p>" .$strings['text'] . "</p>";
               for ($i=0; $i <count($subParagraphs) ; $i++) { 
                   echo "<p>" . $subParagraphs[$i] . "</p>" . "<br>";
               }
            }
